...
class LogicGatesGUI extends JFrame implements ActionListener
{
   ...
   LogicGatesGUI()
   {
      ...
      tres = new JTextField(10); tres.setEditable(true);
   ...
   {
      if (!(num1.getText().equals("true")) || (num2.getText().equals("false")))
      {
         tres.setText("INVALID");
      }
      else{
...
class LogicGates{
 //boolean num1, num2, res;
   ...
   public boolean XOR(boolean num1,boolean num2){
      if( (num1 == false && num2 == false) || (num1 == true && num2 == true))
         return false; 
      else
         return true;
   }
